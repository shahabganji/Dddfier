...
public sealed class AggregateIdGenerator : IIncrementalGenerator
{
        ...
        WithIdOfAttributeContextModel model)
    {
        ...
        productionContext.AddSource($"{model.Namespace}.{model.ClassName}Id.g.cs",
            $$"""
              // <auto-generated />
              ...
              {
                 private readonly global::{{model.TypeName}} _value;
            
                 private CustomerId(global::{{model.TypeName}} id)
                 {
                     _value = id;
                 }
            
                 public static implicit operator global::{{model.TypeName}}(CustomerId id) => id._value;
                 public static explicit operator CustomerId(global::{{model.TypeName}} id) => new(id);
